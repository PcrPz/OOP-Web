...
class GetAvailableCarGUI:
    ...
    def __init__(self,token):
        ...
        self.__sd_entry = Entry(self.__find_available_car, font=self.__normal_font)
        ...
        self.__ed_entry = Entry(self.__find_available_car, font=self.__normal_font)
        ...
        Button(text="Search", font=self.__normal_font, command = self.find_avalible).place(x=100, y=250)
        self.__sd_entry.get()
        self.__st_entry.get()
        self.__ed_entry.get()
        self.__et_entry.get()
